...
class Architect(object):
    def __init__(self, model, criterion, args):
        ...
        self.optimizer = torch.optim.Adam(self.model.arch_parameters(),
                                          lr=args.arch_lr, betas=(args.beta1, args.beta2),
    ...
    def _backward_step_unrolled(self, input_train, target_train, input_valid, target_valid, network_lr, network_optimizer):
        unrolled_model = self._compute_unrolled_model(input_train, target_train, network_lr, network_optimizer)
        ...
        for g, ig in zip(dalpha, implicit_grads):
            g.data.sub_(network_lr, ig.data)
