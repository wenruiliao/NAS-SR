...
class PAConv(nn.Module):
    ...
    def __init__(self, nf, k_size=3):
        ...
        self.sigmoid = nn.Sigmoid()
        self.k3 = nn.Conv2d(nf, nf, kernel_size=k_size, padding=(k_size - 1) // 2, bias=False) # 3x3 or 5x5 convolution
...
class CSSA(nn.Module):
    def __init__(self, C):
        ...
        self.pa_1 = PAConv(inner_C, k_size=5)  # PA_up
        self.pa_2 = PAConv(inner_C, k_size=3)
