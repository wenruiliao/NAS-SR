...
# Data specifications
parser.add_argument('--dir_data', type=str, default='/home/zhao/liaowenrui/srdata',
                    choices=['F:/datasets/Super Resolution/', '../../../../srdata_ex', '/home/zhao/liaowenrui/srdata'])
...
# test
parser.add_argument('--create_results', action='store_true')
parser.add_argument('--pre_train', type=str, default='./pre_train_model/2020-10-14-final-train_model_best.pt')
parser.add_argument('--test_dir', type=str, default='./SR_2020-10-14-final-train_model_best')
parser.add_argument('--testset', type=str, default='Set5', choices=('Set5','Set14','BSD100','Urban100','Manga109'), help='dataset name for testing')
